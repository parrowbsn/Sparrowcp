...
# Notify and Delete Media (Audio, Photos, Videos, Documents, Stickers, GIFs)
@app.on_message(filters.group & (filters.audio | filters.photo | filters.video | filters.document | filters.sticker | filters.animation))
...
async def delete_edited_messages(client, edited_message):
    try:
        ...
        print(f"Error deleting edited message {edited_message.message_id}: {e}")
